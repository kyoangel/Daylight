...
final List<Holiday> taiwanHolidays = [
  ...
  Holiday(DateTime(2025, 1, 27), 'holiday:lunar_new_year'),
  ...
  Holiday(DateTime(2025, 2, 1), 'holiday:lunar_new_year'),
  Holiday(DateTime(2025, 2, 2), 'holiday:lunar_new_year'),
  ...
  Holiday(DateTime(2025, 4, 4), 'holiday:qingming'),
  Holiday(DateTime(2025, 5, 1), 'holiday:labor'),
  Holiday(DateTime(2025, 5, 30), 'holiday:dragon_boat'),
  Holiday(DateTime(2025, 9, 28), 'holiday:confucius'),
  Holiday(DateTime(2025, 9, 29), 'holiday:confucius'),
  Holiday(DateTime(2025, 10, 6), 'holiday:mid_autumn'),
  Holiday(DateTime(2025, 10, 10), 'holiday:national_day'),
  Holiday(DateTime(2025, 10, 24), 'holiday:retrocession'),
  ...
  Holiday(DateTime(2026, 2, 27), 'holiday:peace_memorial'),
